    ...
    <div className="min-h-screen flex justify-center items-center mx-auto bg-white text-black dark:bg-slate-950 dark:text-white transition-colors duration-300">
      <div className="w-full sm:max-w-md">  
        ...
        <div className='flex flex-col items-center mb-4'>
          <UserRoundPlus className='w-20 h-20 border border-gray-300 rounded-lg p-2'/>
          <h2 className='text-3xl font-bold text-slate-900 dark:text-slate-100'>Create a new Account</h2>
      ...
      {/* form info  */}
        <div className='bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800
          ...
          {/* username */}
            <div className='mb-6'>
              <label className='block text-gray-700 dark:text-gray-400 text-sm font-semibold mb-2'
              htmlFor='username'>
                Username
              </label>
              <input
              type="username" 
              id="username" 
              className='w-full px-4 py-2 border rounded-md focus:outline-none focus:ring-2 focus:ring-slate-500 text-slate-500 dark:text-slate-200 '
              placeholder='Johndeo'
              value={username}
           ...
           <div className="mb-6">
            ...
            {/* confrim Password */}
             <div className="mb-6">
              <label className="block text-gray-700 dark:text-gray-400 text-sm font-semibold mb-2" htmlFor="confirmPassword">
                Confirm Password
              </label>
              <input
                id="confirmPassword"
           ...
           <div className="text-center mt-6">
            <p className="text-gray-600 text-sm">
              ...
              <Link to="/login" className="dark:text-slate-100 hover:text-slate-500 text-slate-900 font-semibold">
                Sign in
              </Link>
            </p>
          </div>
